...
def generate_launch_description():
    ...
    robot_localization_file_path = os.path.join(pkg_path, 'config','gps_ekf.yaml')

    navsat_transform_file_path = os.path.join(pkg_path, 'config','navsat_transform.yaml') 
    ...
    rviz_config_file = os.path.join(pkg_path, 'rviz', 'odom_compare.rviz')
